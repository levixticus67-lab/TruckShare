...
import { EAC_LOCATIONS, routeStopsFor } from "@/lib/locations";
...
function RoutePreview({ origin, originCountry, destination, destinationCountry }: { origin: string; originCountry: string; destination: string; destinationCountry: string }) {
  const stops = routeStopsFor(origin, originCountry, destination, destinationCountry);
