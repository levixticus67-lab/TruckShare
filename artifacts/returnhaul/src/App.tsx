...
function TripsPage() {
  ...
  const [form, setForm] = useState({ origin: "Kampala", originCountry: "UG", destination: "Nairobi", destinationCountry: "KE", departureDate: "2026-09-10", departureTime: "07:00", vehicleType: "Fuso", capacityTons: "8", capacityM3: "42", price: "680000", currency: "UGX", priceType: "Fixed" });
